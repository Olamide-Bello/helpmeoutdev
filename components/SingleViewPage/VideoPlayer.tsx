...
const VideoPlayer: React.FC<VideoPlayerProps> = ({
  ...
  const playPauseIcon = isPlaying ? (
    ...
    viewBox="0 0 16 16"
>
<path d="M4.5 0v12L12 6z" fill="#808080"></path>
</svg>
  )
  ...
  return (
    <div onMouseEnter={showPlayBotton}
    onMouseLeave={hidePlayButton} className="pt-2 px-2 pb-3 bg-[#FBFBFB80] relative  rounded-[24px] border border-gray-200 border-opacity-60 bg-opacity-50 h-full">
