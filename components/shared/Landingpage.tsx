  ...
  return (
    <>
        ...
        <div className="lg:flex px-4 md:px-8 lg:px-12 xl:px-16 min-h-[80vh] items-center">
          ...
          <div className="w-auto h-auto flex flex-col md:flex-row gap-[20px] px-[40px] relative">
            <Image src={Hero} width={700} height={500} alt="Hero Image" />
          </div>
        </div>
        ...
        <div className="px-4 md:px-8 lg:px-12 xl:px-16 pb-8 lg:pb-16">
          <h3 className="font-sora font-bold text-3xl md:text-4xl text-center pt-8 pb-6 lg:pt-12 lg:pb-8">
            How it Works
          </h3>
